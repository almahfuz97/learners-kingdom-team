...
export default function Profile() {
    ...
    return (
        ...
        <div className=' min-h-screen p-4 shadow-lg rounded-lg bg-pink-50 flex justify-center '>
            <div>
                <h1 className=' font-bold text-2xl uppercase text-primary_color text-center '>Your Profile</h1>

                <div className='flex flex-col gap-6 '>
                    <div className='border mt-4 p-4 min-w-[400px] rounded-lg shadow-lg flex flex-col justify-center items-center'>
                        ...
                        <div className='mt-8'>
                            <div className=' flex  gap-4 text-slate-900 mb-2'>
