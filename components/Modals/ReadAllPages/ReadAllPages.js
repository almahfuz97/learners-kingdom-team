...
export default function ReadAllPages({ setModalToggle, book }) {
    return (
        <div id='modal' className="relative mx-auto md:w-1/2 w-4/5 max-h-[500px] overflow-auto mt-20 opacity-100 bg-slate-100 text-white  p-6 rounded-md  sm:py-8 sm:px-12 shadow-lg">
