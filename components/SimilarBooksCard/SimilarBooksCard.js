...
const SimilarBooksCard = ({ book }) => {
    ...
    return (
        <div onClick={() => router.push(`/book/${book._id},${book.categoryID}`)} className="flex flex-col gap-1 p-3 bg-primary_color/30 rounded-md hover:scale-105 transition-all cursor-pointer">
