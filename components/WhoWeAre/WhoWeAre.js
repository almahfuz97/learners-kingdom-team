...
const WhoWeAre = () => {
    return (
        <div className="container max-w-screen-2xl mx-auto bg-primary_color/30 p-6 lg:px-20 lg:py-16">
            <div className="max-w-screen-xl mx-auto md:flex items-center gap-8 lg:gap-16">
                <div className="md:w-1/2">
                    <img src="https://i.ibb.co/9yrbPKC/books.jpg" alt="" />
                </div>
                <div className="md:w-1/2 mt-8 md:mt-0">
                    <p className="font-medium text-lg mb-2">Welcome to the Wonderful Kingdom of Books</p>
                    <h4 className="text-3xl font-bold mb-6">Learner's Kingdom is an Online Bookstore</h4>
