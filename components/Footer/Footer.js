                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <nav aria-label="Footer About Nav" className="mt-8">
                                <ul className="space-y-4 text-sm">
                                    <li>
                                        <a className="text-gray-700 transition hover:text-primary_color" href="/">
                                            Company History
                                        </a>
                                    </li>
                                    <li>
                                ...
                                <ul className="space-y-4 text-sm">
                                    ...
                                    <li>
                                        <a className="group flex justify-center gap-1.5 sm:justify-start" href="/">
                                            <span className="text-gray-700 transition group-hover:text-primary_color">
                                                Live Chat
                                            </span>
